...
// =============================================================
// KROK DIAGNOSTYCZNY: Wyświetl zawartość zmiennej PRZED jej użyciem
alert('Zawartość zmiennej supabaseUrl TO: ' + supabaseUrl);
// =============================================================

// Ten kod wykona się dopiero po zamknięciu okienka alertu
export const supabase = createClient(supabaseUrl, supabaseKey);
